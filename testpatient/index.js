    ...
    exports.handler = async (event) => {
        ...
        if (event.request.type== "IntentRequest")
        {
            if(event.request.intent.name=="PatientPhoto")
            {
                ...
                {
                    var imageList = await ImageOperations.listImages(result_temp);
            ...
            else if(event.request.intent.name == "register")
            {
                ...
                return {"version" : 1.0,
                    ...
                    outputSpeech:{
                    type: "PlainText",
                    text:"Thank you.Registered sucessfully. Please use my lastname is to login.For example My lastname is Serai"
                    },
                    shouldEndSession:false
                    }
            };
